    ...
    <div className="p-4 md:p-8">
      ...
      {grupos.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-500 font-medium mb-1">Sin grupos todavía</p>
          <p className="text-sm text-gray-400 mb-4">Crea un grupo para gestionar reservas de familias o grupos que ocupen varias habitaciones.</p>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-mono text-xs text-gray-400">{g.codigoGrupo}</span>
                    </div>
