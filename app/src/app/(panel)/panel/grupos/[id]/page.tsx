        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <form action={actualizarGrupoAction} className="space-y-3">
              ...
              {usuario.propiedad.planActivo === "PRO" && (
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">Los pagos con tarjeta actualizan este campo automáticamente. Edítalo para registrar pagos en efectivo o corregir el saldo.</p>
                </div>
              )}
              <div>
