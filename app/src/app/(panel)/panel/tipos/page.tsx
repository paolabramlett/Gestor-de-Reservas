          ...
          <div key={t.id} className="bg-white rounded-lg border border-gray-200 p-5 flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-500 mt-1">
                ...
                {" "}(
                {t.tarifaBaseModalidad === "POR_HABITACION" && "por habitación"}
                {t.tarifaBaseModalidad === "POR_PERSONA" && "por persona"}
                {t.tarifaBaseModalidad === "BASE_MAS_SUPLEMENTO" &&
                  `base + $${Number(t.suplementoPorPersona ?? 0).toLocaleString("es-MX")} por persona adicional`}
                )
              </div>
