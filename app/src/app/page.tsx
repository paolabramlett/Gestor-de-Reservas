...
function EntradaInicioSesion({
  ...
  return (
    <form action="/api/auth/iniciar-sesion" method="post" style={{ display: "inline-flex" }}>
      <button type="submit" className={className} style={{ cursor: "pointer", fontFamily: "inherit", ...style }}>
        {children}
      </button>
    </form>
  );
    ...
    <>
      ...
      <nav style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"18px 48px",background:"#fff",borderBottom:"1px solid #e5e7eb",position:"sticky",top:0,zIndex:50}}>
        ...
        <ul className="nav-links-desktop">
          ...
          <li>
            <EntradaInicioSesion className="nav-sign-in" style={{fontSize:"0.82rem",fontWeight:500,color:"#041B42",background:"transparent",border:"1px solid #CBD5E1",padding:"8px 18px",borderRadius:8,display:"flex",alignItems:"center",gap:6}}>
              Iniciar sesión
            </EntradaInicioSesion>
          </li>
          <li>
      ...
      <div className="hero-grid">
        <div>
          ...
          <div className="hero-btns" style={{display:"flex",alignItems:"center",gap:16,marginBottom:48,flexWrap:"wrap"}}>
            ...
            <EntradaInicioSesion className="nav-sign-in" style={{display:"inline-flex",alignItems:"center",gap:6,background:"#EEEEEE",color:"#041B42",border:0,padding:"13px 24px",borderRadius:10,fontSize:"0.9rem",fontWeight:500}}>
              Iniciar sesión
            </EntradaInicioSesion>
          </div>
      ...
      <section style={{background:"#0C48AD",padding:"80px 48px",textAlign:"center",color:"#fff"}}>
        ...
        <div className="cta-btns" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:16,flexWrap:"wrap"}}>
          ...
          <EntradaInicioSesion style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(255,255,255,0.12)",color:"#fff",border:"1px solid rgba(255,255,255,0.3)",padding:"14px 28px",borderRadius:10,fontSize:"0.95rem",fontWeight:500}}>
            Ya tengo cuenta
          </EntradaInicioSesion>
        </div>
      ...
      <footer style={{background:"#041B42",padding:"32px 48px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}>
        ...
        <div style={{display:"flex",gap:20}}>
          ...
          <EntradaInicioSesion style={{fontSize:"0.78rem",color:"#94a3b8",background:"transparent",border:0,padding:0}}>Iniciar sesión</EntradaInicioSesion>
        </div>
      </footer>
    </>
  );
